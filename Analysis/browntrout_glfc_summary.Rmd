...
df <- read.csv("~/projects/brown/Data/Raw/bt_glfc.csv") # previously downloaded - brown trout only
...
stglkup <- read_xlsx("~/projects/brown/Data/Lookup/GLFSD_NewDataSubmission_Template.xlsx", sheet = "Lifestage")
