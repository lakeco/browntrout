...
df10 <- read.csv("~/projects/brown/Data/Spatial/gl_10min_grid.csv", stringsAsFactors = FALSE)
...
map <- leaflet(width = "100%", height = 800) %>%
  ...
  addCircleMarkers(data = sd, lat = ~lat_grid, lng = ~lon_grid, radius = ~biomass/100,
                   stroke = TRUE,
                   color = "black",
                   weight = 1,
