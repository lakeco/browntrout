...
load(file = "~/projects/browntrout/Data/Processed/brown_fsis.rda")
...
fmz <- readOGR("~/projects/browntrout/Data/Spatial/fmz.kml", verbose = FALSE)
...
zone20 <- read.csv("~/projects/browntrout/Data/Lookup/fmzcorrection.csv", stringsAsFactors = FALSE)
